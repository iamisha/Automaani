...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-16 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:isha@automaani.com" className="text-gray-400 hover:text-blue-300 transition-colors">contact@automaani.com</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gray-400 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
